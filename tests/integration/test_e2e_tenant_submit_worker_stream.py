...
import scripts.e2e_tenant_submit_worker_stream as proof
...
@pytest.mark.asyncio
async def test_e2e_tenant_submit_worker_stream_passes() -> None:
...
@pytest.mark.asyncio
async def test_e2e_tenant_submit_worker_stream_degrades_without_redis() -> None:
...
@pytest.mark.asyncio
async def test_e2e_tenant_submit_worker_stream_writes_dashboard_artifact(tmp_path, monkeypatch) -> None:
    output = tmp_path / "latest_e2e_tenant_submit_worker_stream.json"
    ...
    assert data["source"] == "e2e_tenant_submit_worker_stream"
